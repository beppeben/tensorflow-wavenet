...
def validate_directories(args):
    ...
    if args.sample_size is not 0 and args.lc_windows is not None:
        raise ValueError("When using local conditioning sample size should be zero.")
...
def main():
    ...
    net = WaveNetModel(
        ...
        local_condition_cardinality=reader.lc_character_cardinality,
